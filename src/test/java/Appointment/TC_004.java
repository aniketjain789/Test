...
public class TC_004 {
	...
	public void verify_appoinment() {
		...
		System.out.println("gettokn_no  :" + gettokn_no);

		d.click(txt_cancel);
		int actual = Integer.parseInt(gettokn_no);

		List<WebElement> lastelement = driver.findElements(By.id("clinicsAppointmentList_item_appointment_no"));

		System.out.println("lastelement  :" + lastelement.size());
		if (actual == lastelement.size()) {
			System.out.println("TEST CASE PASSSSSSSSSSSSS.....!");
	...
	public void Appointment_TC_03(String Date, String group, String name, String contact, String gender, String address,
			String age, String amt) throws InterruptedException, IOException, ParseException {
	...
	public Object[][] dp() {
		return new Object[][] {
				new Object[] { "12/03/2018", "Group-rajesh", "c", "8876543415", "pune", "F", "26", "204" } };
	}
