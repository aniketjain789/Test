...
//	  open_tab();
	  ...
	  {add_medicine(medi_name, time, when, unit_days, addi_details);
	  loop++;}	  
	  else
	  {
...
//	  driver.findElement(By.xpath("//android.view.View[@index='2']")).click();
  ...
  public void add_details(String bp,String opd_name)
  {
	  d.click(date_ok);
	  d.click(bp_bx);
...
//	  driver.findElement(By.name(opd_name)).click();
	  List<WebElement> opd_name_list = driver.findElements(opd_list);
//	  System.out.println(opd_name_list.size());
	  for(WebElement we : opd_name_list)
	  {
		  String temp = we.getText();
//		  System.out.println("Axy:-"+temp);
...
public void add_medicine(String medi_name,String time, String when, String unit_days, String addi_details)
{
